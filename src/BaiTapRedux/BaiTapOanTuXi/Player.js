        ...
        return (
            <div className="playerGame">
                <div className="theThink">
                    <img style={{transform: 'rotate(90deg)'}}className="mt-3" width={100} height={100} src={this.props.mangDatCuoc.find(item=>item.datCuoc===true).hinhAnh} alt={this.props.mangDatCuoc.find(item=>item.datCuoc===true).hinhAnh}/>
                </div>
